...
export default function Verification() {
  useEffect(() => {
    document.title = "Verification - eTrolly";

    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute("content", "Verify your eTrolly account");
    } else {
      const newMetaDescription = document.createElement("meta");
      newMetaDescription.name = "description";
      newMetaDescription.content = "Verify your eTrolly account";
  ...
  return (
    <AuthLayout>
      <section className="w-full h-screen flex flex-col justify-center items-center">
        <div>
          <div className="w-full max-w-md flex justify-center ml-32">
          <svg
            viewBox="0 0 280 80"
